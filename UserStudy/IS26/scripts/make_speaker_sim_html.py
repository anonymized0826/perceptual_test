...
<title>Speaker Similarity ABX Test</title>
<style>
...
<body>
<h1>Speaker Similarity ABX Test</h1>
<p class="note">For each question, listen to the reference clip X (target speaker), then clips A and B. Decide which of A or B sounds more like the same speaker as X. Then mark your confidence.</p>
<div class="hr"></div>
""")
        ...
        for i in range(num_sets):
            ...
            for j in range(set_size):
                ...
                for wav_url in (row["wav_fpath_x"], row["wav_fpath_a"], row["wav_fpath_b"]):
...
def main():
    ...
    parser.add_argument("--public_base", type=str, required=True,
                        help="Base URL that maps to samples_root on GitHub Pages, e.g., "
                             "'https://anonymized0826.github.io/perceptual_test/UserStudy/IS26/Samples/SpeakerSim/'")
    parser.add_argument("--seed", type=int, default=1337)
    parser.add_argument("--set_size", type=int, default=5, help="Questions per set")
